...
class PeminjamanController extends Controller
{
    ...
    public function updateReturnStatus(Request $request, Pengembalian $pengembalian): JsonResponse
    {
        $data = $request->validate([
    ...
    public function bulkUpdateReturnStatus(Request $request): JsonResponse
    {
        $data = $request->validate([
            'ids' => ['required', 'array'],
    ...
    public function destroyReturn(Pengembalian $pengembalian): JsonResponse
    {
        $pengembalian->delete();
    ...
    public function bulkDeleteReturns(Request $request): JsonResponse
    {
        $data = $request->validate([
            'ids' => ['required', 'array'],
            'ids.*' => ['exists:pengembalian,id'],
